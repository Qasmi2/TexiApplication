                        ...
                        <a className="text-black" href="#">
                            <div className="media">
                                <div className="media-body">
		                            ...
		                            {
                                        trip.status != 'SEARCHING' && trip.status != 'COMPLETED' && trip.status != 'CANCELLED' &&
                                        <div>
                                          <h6 className="media-heading">Driver Name: {trip.provider.first_name} {trip.provider.last_name}</h6>
                                          <h6 className="media-heading">Driver Phone: {trip.provider.mobile}</h6>                                       
                                          <h6 className="media-heading">Service: {trip.service_type.name}</h6>
										<h6 className="media-heading">Car: {trip.provider_service.service_model}</h6>
										<h6 className="media-heading">Car Number: {trip.provider_service.service_number}</h6>
                                        </div>
                                    }
