...
<div class="content-area py-1">
    <div class="container-fluid">
        <div class="box box-block bg-white">
            ...
            <h5 style="margin-bottom: 2em;">Atualizar Usuário</h5>
            ...
            <form class="form-horizontal" action="{{route('admin.service.update', $service->id )}}" method="POST" enctype="multipart/form-data" role="form">
                ...
                <div class="form-group row">
                    <label for="name" class="col-xs-2 col-form-label">Nome do Serviço</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="provider_name" class="col-xs-2 col-form-label">Nome do Motorista</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    ...
                    <label for="image" class="col-xs-2 col-form-label">Foto</label>
                    <div class="col-xs-10">
				...
				<!-- icon  -->
				 <div class="form-group row">
                    ...
                    <label for="image" class="col-xs-2 col-form-label">Icon</label>
                    <div class="col-xs-10">
                        @if(isset($service->icon))
                        <img style="height: 90px; margin-bottom: 15px; border-radius:2em;" src="{{ $service->icon }}">
                        @endif
                        <input type="file" accept="image/*" name="icon" class="dropify form-control-file" id="image" aria-describedby="fileHelp">
                    </div>
                </div>
				<!-- End -->

                <div class="form-group row">
                    <label for="fixed" class="col-xs-2 col-form-label">Preço Base ({{ currency('') }})</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    <label for="capacity" class="col-xs-2 col-form-label">Capacidade de Assento</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    <label for="calculator" class="col-xs-2 col-form-label">Lógica de Preços</label>
                    <div class="col-xs-10">
                ...
                <div class="form-group row">
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <a href="{{route('admin.service.index')}}" class="btn btn-danger btn-block">Cancelar</a>
                    </div>
                    <div class="col-xs-12 col-sm-6 offset-md-6 col-md-3">
                        <button type="submit" class="btn btn-primary btn-block">Atualizar Tipo de Serviço</button>
                    </div>
                </div>
            </form>
        </div>
