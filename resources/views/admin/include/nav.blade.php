		...
		<ul class="sidebar-menu">
			...
			<li class="with-sub">
				<a href="#" class="waves-effect  waves-light">
					<span class="s-caret"><i class="fa fa-angle-down"></i></span>
					<span class="s-icon"><i class="ti-view-grid"></i></span>
					<span class="s-text">Cancel Rides</span>
				</a>
				<ul>
					<li><a href="{{route('admin.user.cancel') }}">User Cancel Rides</a></li>
					<li><a href="{{ route('admin.provider.cancel') }}">Provider Cancel Rides</a></li>
				</ul>
			</li>
